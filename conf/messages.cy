...
previousDeclarationDetails.add_goods = Gallwch ond ychwanegu rhagor o nwyddau at y datganiad hwn, ni allwch newid unrhyw fanylion eraill. Gwnewch yn siŵr bod cyfanswm gwerth y nwyddau i gyd ddim yn fwy na {0}.
previousDeclarationDetails.allowance.p1 = Mae gennych £
previousDeclarationDetails.allowance.p2 = yn weddill o’ch lwfans o {0}.
...
# ValueWeightOfGoods
valueWeightOfGoods.NorthernIreland.title = A yw cyfanswm gwerth y nwyddau o dan {0} ac a ydynt yn pwyso llai na 1,000 cilogram?
valueWeightOfGoods.GreatBritain.title = A yw cyfanswm gwerth y nwyddau o dan {0} ac a ydynt yn pwyso llai na 1,000 cilogram?
valueWeightOfGoods.NorthernIreland.heading = A yw cyfanswm gwerth y nwyddau o dan {0} ac a ydynt yn pwyso llai na 1,000 cilogram?
valueWeightOfGoods.GreatBritain.heading = A yw cyfanswm gwerth y nwyddau o dan {0} ac a ydynt yn pwyso llai na 1,000 cilogram?
valueWeightOfGoods.GreatBritain.error.required = Dewiswch ‘Iawn’ os yw cyfanswm gwerth y nwyddau o dan {0} ac os ydynt yn pwyso llai na 1,000 cilogram
valueWeightOfGoods.NorthernIreland.error.required = Dewiswch ‘Iawn’ os yw cyfanswm gwerth y nwyddau o dan {0} ac os ydynt yn pwyso llai na 1,000 cilogram
...
reviewGoods.allowance.left = yn weddill o’ch lwfans o {0}.
reviewGoods.allowance.over = Ni allwch ychwanegu nwyddau sydd werth cyfanswm o fwy na {0} at y datganiad hwn.
...
# GoodsOverThreshold
goodsOverThreshold.NorthernIreland.title = Mae cyfanswm gwerth eich nwyddau dros {0}
goodsOverThreshold.GreatBritain.title = Mae cyfanswm gwerth eich nwyddau dros {0}
goodsOverThreshold.NorthernIreland.heading = TMae cyfanswm gwerth eich nwyddau dros {0}
goodsOverThreshold.GreatBritain.heading = Mae cyfanswm gwerth eich nwyddau dros {0}
goodsOverThreshold.NorthernIreland.Import.p1 = Ni allwch ddefnyddio’r gwasanaeth hwn i ddatgan nwyddau sydd werth dros {0} yr ydych yn dod â nhw i mewn i Ogledd Iwerddon.
goodsOverThreshold.NorthernIreland.Export.p1 = Ni allwch ddefnyddio’r gwasanaeth hwn i ddatgan nwyddau sy’n werth dros {0} yr ydych yn mynd â nhw allan o Ogledd Iwerddon.
goodsOverThreshold.GreatBritain.Import.p1 = Ni allwch ddefnyddio’r gwasanaeth hwn i ddatgan nwyddau rydych yn dod â nhw gyda chi i Brydain Fawr sydd â gwerth dros {0}.
goodsOverThreshold.GreatBritain.Export.p1 = Ni allwch ddefnyddio’r gwasanaeth hwn i ddatgan nwyddau sy’n werth dros {0} yr ydych yn eu cymryd allan o Brydain Fawr.
...
eoriNumber.trader.hint = Mae angen rhif EORI arnoch sy’n dechrau gyda GB i ddefnyddio’r gwasanaeth hwn. Er enghraifft, GB123456780000.
eoriNumber.agent.hint = Bydd angen rhif EORI ar eich cleient, sy’n dechrau gyda GB, i ddefnyddio’r gwasanaeth hwn. Er enghraifft, GB123467800000.
eoriNumber.agent.apply.eori.text = gwneud cais am rif EORI
eoriNumber.trader.apply.eori.text = Gwneud cais am rif EORI
eoriNumber.apply.eori.takes.10.minutes.text = (mae’n cymryd llai na 10 munud fel arfer)
eoriNumber.apply.eori.agent.text = Gall eich cleient
...
checkYourAnswers.amend.sendDeclaration.agent.acknowledgement.1 = Mae’n rhaid iddo ddod â’r datganiad hwn sydd wedi’i ddiweddaru gydag ef
checkYourAnswers.amend.sendDeclaration.trader.acknowledgement.2 = Bydd angen i mi ddangos fy natganiad a derbynebau prynu os byddaf yn cael fy stopio gan Lu’r Ffiniau
checkYourAnswers.amend.sendDeclaration.agent.acknowledgement.2 = Bydd angen iddo ddangos y datganiad hwn a derbynebau prynu os bydd yn cael ei stopio gan Lu’r Ffiniau
...
checkYourAnswers.sendDeclaration.acknowledgement.agent.EU.over.thousand = Mae’n rhaid iddo ddod â thystiolaeth bod ei nwyddau wedi’u gwneud yn yr UE
...
checkYourAnswers.sendDeclaration.Import.trader.acknowledgement.1.zero = Mae’n rhaid i mi ddatgan yr holl nwyddau rwy’n dod â nhw i Brydain Fawr at ddefnydd masnach neu fusnes
checkYourAnswers.sendDeclaration.Import.agent.acknowledgement.1.zero = They must declare all goods they bring into Great Britain for trade or business use
...
checkYourAnswers.sendDeclaration.confirm = Drwy gyflwyno’r datganiad hwn, rydych yn cadarnhau, hyd eithaf eich gwybodaeth, bod y manylion rydych yn eu rhoi’n gywir.
