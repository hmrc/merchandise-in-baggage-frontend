  ...
  "onSubmit" must {
    "return BAD_REQUEST and errors" when {
      "no selection is made" in {
        ...
        content must include("The Customs Duty on most goods has a standard rate of 20% VAT applied to it, but some goods such as children’s clothes have a lower rate.")
